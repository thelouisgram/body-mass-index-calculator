...
const BmiCalculator: React.FC = () => {
  ...
  return (
    <div className={`ss:w-[525px] ss:mx-auto md:mx-0 h-auto bg-white rounded-[20px] shadow text-blue`}>
      <div className="p-4 xs:p-6 ss:p-7">
      <h3 className="text-[20px] font-[700] mb-5">Enter your details below</h3>
